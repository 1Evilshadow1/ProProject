...
import Projet.GenerateurRapport;
import Projet.Project;
import Projet.Rapport;
import Projet.Tache;
import Projet.TaskStatue;
import User.Membre;
...
public class App {
    public static void main(String[] args) throws ParametreInvalideException {
       ...
       ProblemeSysteme pSysteme = new ProblemeSysteme("3", "System issue", ahmed);
        ...
        Tache t1 = new Tache("tache de test",azizM,TaskStatue.A_FAIRE,commentaires, "Simple","A_FAIRE");
        List<Tache> taches = new ArrayList<>();
        taches.add(t1);
        Map<Tache, Integer> avancement = new java.util.HashMap<>();
        avancement.put(t1, 50);
        Project projet = new Project("Projet de test",chef, equipe, taches, avancement);
